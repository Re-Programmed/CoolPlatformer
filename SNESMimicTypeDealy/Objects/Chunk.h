...
namespace GAME_NAME
{
	...
	namespace Objects
	{
		enum RENDER_LAYER
		{
			...
			RENDER_LAYER_OBJECTS_FRONT //OBJECTS ARE GAME OBJECTS THAT WILL NOT MOVE, BUT CAN STILL HAVE COMPONENTS (EX. THE GROUND AND GRASS) [RENDERED AFTER ACTIVE OBJECTS]
		};
		...
		public:
			...
			void Instantiate(GameObject* object, bool front = false);	//Load an object to this chunk.
		...
		private:
			std::vector<GameObject*> m_objects;							//All objects in this chunk.
